...
```
Agent(
  prompt="Read C:/Users/ACER/OneDrive - Universitas Islam Indonesia/Documents/psi/isd-project/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/ACER/OneDrive - Universitas Islam Indonesia/Documents/psi/isd-project/.claude/gsd-core/templates/SECURITY.md`
