...
The keys live in `.claude/settings.json` (project) or `C:/Users/ACER/OneDrive - Universitas Islam Indonesia/Documents/psi/isd-project/.claude/settings.json` (global) — **not** in `.planning/config.json`:
