...
The keys live in `.codex/settings.json` (project) or `C:/Users/ACER/OneDrive - Universitas Islam Indonesia/Documents/psi/isd-project/.codex/settings.json` (global) — **not** in `.planning/config.json`:
