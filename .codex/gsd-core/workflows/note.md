...
- **Global scope**: `C:/Users/ACER/OneDrive - Universitas Islam Indonesia/Documents/psi/isd-project/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/ACER/OneDrive - Universitas Islam Indonesia/Documents/psi/isd-project/.codex/notes/`)
...
2. Glob `C:/Users/ACER/OneDrive - Universitas Islam Indonesia/Documents/psi/isd-project/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/ACER/OneDrive - Universitas Islam Indonesia/Documents/psi/isd-project/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/ACER/OneDrive - Universitas Islam Indonesia/Documents/psi/isd-project/.codex/notes/` — works in any directory
